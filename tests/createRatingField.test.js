...
<fieldset data-bmd-name="rating" data-bmd-type="radio" data-bmd-cast="int" data-bmd-required id="some-id" class="bmd-col-6 bmd-xs:col-10 bmd-form-field bmd-form-field-sm bmd-form-subfield" aria-label="Label" data-title="Some title">
...
<fieldset data-bmd-name="rating" data-bmd-type="radio" data-bmd-cast="int" data-bmd-required id="some-id" class="bmd-col-6 bmd-xs:col-10 bmd-form-field" aria-label="Label" data-title="Some title">
	<legend class="bmd-form-question">
		What is your <span class="bmd-text-nowrap">rating?<sup class="bmd-text-accent">*</sup></span>
	</legend>
	<p class="bmd-form-description">
	...
	<div class="bmd-rating-grid bmd-rating-grid-5-or-more">
		<input 
			name="rating"
			id="id_rating-1"
			type="radio"
		...
		<label class="bmd-form-rating-label" for="id_rating-1">
			...
			<span class="bmd-visually-hidden">1 star</span>
		</label>
		<input 
			name="rating"
			id="id_rating-2"
		...
		<label class="bmd-form-rating-label" for="id_rating-2">
			...
			<span class="bmd-visually-hidden">2 stars</span>
		</label>
		<input 
			name="rating"
			id="id_rating-3"
		...
		<label class="bmd-form-rating-label" for="id_rating-3">
			...
			<span class="bmd-visually-hidden">3 stars</span>
		</label>
		<input 
			name="rating"
			id="id_rating-4"
		...
		<label class="bmd-form-rating-label" for="id_rating-4">
			...
			<span class="bmd-visually-hidden">4 stars</span>
		</label>
		<input 
			name="rating"
			id="id_rating-5"
		...
		<label class="bmd-form-rating-label" for="id_rating-5">
			...
			<span class="bmd-visually-hidden">5 stars</span>
		</label>
		<input 
			name="rating"
			id="id_rating-6"
			...
			value="6"
		>
		<label class="bmd-form-rating-label" for="id_rating-6">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="bmd-form-rating-svg" aria-hidden="true" focusable="false">
				<path d="M288.1 0l63.5 195.6H557.2L390.9 316.4 454.4 512 288.1 391.1 121.7 512l63.5-195.6L18.9 195.6H224.5L288.1 0z" class="bmd-form-rating-svg-path-inner"/>
				<path d="M351.6 195.6L304.9 51.8 288.1 0 271.2 51.8 224.5 195.6l-151.2 0-54.4 0 44 32 122.3 88.9L138.5 460.2 121.7 512l44-32 122.3-88.9L410.4 480l44 32-16.8-51.8L390.9 316.4l122.3-88.9 44-32-54.4 0-151.2 0zm107.1 32l-86.7 63-18.8 13.7 7.2 22.1 33.1 101.9-86.7-63-18.8-13.7-18.8 13.7-86.7 63 33.1-101.9 7.2-22.1L204 290.5l-86.7-63 107.1 0 23.2 0 7.2-22.1 33.1-101.9 33.1 101.9 7.2 22.1 23.3 0 107.1 0z" class="bmd-form-rating-svg-path-outer"/>
			</svg>
			<span class="bmd-visually-hidden">6 stars</span>
		</label>
	</div>
</fieldset>
`;
...
<fieldset data-bmd-name="rating" data-bmd-type="radio" data-bmd-cast="int" data-bmd-required class="bmd-form-field">
	<legend class="bmd-form-question">
		What is your <span class="bmd-text-nowrap">rating?<sup class="bmd-text-accent">*</sup></span>
	</legend>
	<p class="bmd-form-description">
	...
	<div class="bmd-rating-grid">
		...
		<label class="bmd-form-rating-label" for="id_rating-1">
			...
			1<span class="bmd-visually-hidden"> স্টার</span>
		</label>
		<input 
			name="rating"
			id="id_rating-2"
		...
		<label class="bmd-form-rating-label" for="id_rating-2">
			...
			2<span class="bmd-visually-hidden"> স্টার</span>
		</label>
	</div>
</fieldset>
`;
