		...
		<label class="bmd-form-file-label">
			...
			<span class="bmd-d-block bmd-w-auto bmd-mw-100">
				...
				<span class="bmd-file-empty-section">
					...
					<span class="bmd-d-block bmd-mt-3">
						Change: <strong class="bmd-text-accent">Choose file</strong><span class="bmd-xs:d-none"> or drag here</span>
					</span>
				</span>
				<span class="bmd-file-exists-section"></span>
				<span class="bmd-form-file-size-limit bmd-mt-1">
		...
		<div class="bmd-current-file-clear">
			<div class="bmd-form-check">
				<input
					...
					value="Clear"
				>
				<label class="bmd-form-check-label" for="id_portfolioClear">
		...
		<label class="bmd-form-file-label">
			...
			<span class="bmd-d-block bmd-w-auto bmd-mw-100">
				...
				<span class="bmd-file-empty-section">
					...
					<span class="bmd-d-block bmd-mt-3">
						পালটান: <strong class="bmd-text-accent">ফাইল বেছে নিন</strong><span class="bmd-xs:d-none"> বা এখানে টেনে আনুন</span>
					</span>
				</span>
				<span class="bmd-file-exists-section"></span>
				<span class="bmd-form-file-size-limit bmd-mt-1">
