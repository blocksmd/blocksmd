...
const translations = {
	...
	ar: {
		...
		"end-slide-subtitle": "لقد وصلت إلى النهاية. شكراً للقراءة!",
		...
		"form-submitted-subtitle": "تم تسجيل إجابتك. شكراً لك!",
		"list-check": "غير محدد",
		"list-checked": "محدد",
	...
	de: {
		...
		"end-slide-subtitle": "Sie haben das Ende erreicht. Danke fürs Lesen!",
		...
		"form-submitted-subtitle": "Ihre Antwort wurde gespeichert. Vielen Dank!",
	...
	fr: {
		...
		"end-slide-subtitle": "Vous êtes arrivé à la fin. Merci d'avoir lu !",
		...
		"form-submitted-subtitle": "Votre réponse a été enregistrée. Merci !",
	...
	ja: {
		...
		"end-slide-subtitle": "最後まで読んでいただき、ありがとうございます！",
		...
		"form-submitted-subtitle": "回答を記録しました。ありがとうございます！",
		"list-check": "未チェック",
		"list-checked": "チェック済み",
		"loading": "読み込み中",
	...
	pt: {
		...
		"end-slide-subtitle": "Você chegou ao fim. Obrigado por ler!",
		...
		"form-submitted-subtitle": "Sua resposta foi registrada. Obrigado!",
	...
	zh: {
		...
		"end-slide-title": "感谢",
		"end-slide-subtitle": "您已到达末尾。感谢阅读！",
		...
		"form-submitted-subtitle": "您的回复已记录。谢谢！",
		"list-check": "未选中",
		"list-checked": "已选中",
		"loading": "加载中",
